...
class ParameterInputGroup(QWidget):
    ...
    def retranslateUi(self):
        """
        Updates all user-visible text in the widget.
        """
        self.help_button.setToolTip(self.tooltip_text)

    def changeEvent(self, event: QEvent):
        """
        Handles the LanguageChange event to allow for dynamic translation.
        """
    ...
    def set_label_text(self, text: str):
        """Set the label text for this parameter input group."""
        self.label.setText(f"{text}:")

    def set_value(self, value: Any, emit_signal: bool = True):

...
from PyQt6.QtCore import Qt, QPointF, QRectF, pyqtSignal, QPoint, QEvent
...
class DepthProfileEditor(QWidget):
    ...
    def _draw_axes(self, painter: QPainter):
        ...
        painter.drawText(QRectF(0, 0, self.MARGIN - 5, 20), Qt.AlignmentFlag.AlignVCenter | Qt.AlignmentFlag.AlignRight, f"{self.get_path()[0].y():.0f} {self.tr('ft')}")
        painter.drawText(QRectF(0, self.height() - self.MARGIN - 20, self.MARGIN - 5, 20), Qt.AlignmentFlag.AlignVCenter | Qt.AlignmentFlag.AlignRight, f"{self.get_path()[-1].y():.0f} {self.tr('ft')}")
    ...
    def _draw_hover_tooltip(self, painter: QPainter):
        ...
        text = f"{self.tr('MD:')} {self._hover_point_data.y():.1f}\n{self.tr('Dev:')} {self._hover_point_data.x():.1f}"
    ...
    def changeEvent(self, event: QEvent):
        """Repaints the widget when the application's language changes."""

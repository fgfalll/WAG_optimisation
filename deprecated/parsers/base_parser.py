...
from .validation import validate_reservoir_data, validate_well_data
...
class BaseParser(metaclass=abc.ABCMeta):
    """
    [DEPRECATED] Abstract base class for all data parsers in the CO₂ EOR optimization suite.
    Defines the common interface and implements shared functionality.
    Deprecated as part of the consolidation to the intermediate physics surrogate engine
    and direct utility parsers (utils/las_parser.py).
    """

...
class EclipseParser(BaseParser):
    """
    [DEPRECATED] Experimental Eclipse deck parser.
    Deprecated because CO2 EOR Optimizer consolidated around the fast surrogate engine
    (core/engine_surrogate) rather than full 3D ECLIPSE block-centered simulation.
    """
    def __init__(self):
        super().__init__()

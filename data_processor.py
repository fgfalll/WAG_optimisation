...
# These imports are relative to the project structure, assuming the project root is in PYTHONPATH
...
class DataProcessor:
    ...
    def process_files(
        ...
        if not files_to_process:
            logger.warning("No supported files (.las) found in the provided list.")
        ...
        # Use os.cpu_count() to dynamically set worker count for better performance.
